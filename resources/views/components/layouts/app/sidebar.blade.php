        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="book-open" :href="route('client-contacts.index')" :current="request()->routeIs('client-contacts.*')" wire:navigate>{{ __('Client Contacts') }}</flux:navlist.item>
                    ...
                    <flux:navlist.item icon="envelope-open" :href="route('notification-templates.index')" :current="request()->routeIs('notification-templates.*')" wire:navigate>{{ __('Notification Templates') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
