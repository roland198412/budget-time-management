<section>
    @include('partials.heading', ['heading' => __('New Payment'), 'description' => __('Create new user payment') ])
    ...
    <form wire:submit="save" class="my-6 w-full space-y-6">
        ...
        <div class="p-4 rounded-lg {{ $this->balanceDue > 0 ? 'bg-red-50 border border-red-200' : 'bg-green-50 border border-green-200' }}">
            <div class="flex justify-between items-center">
                ...
                <span class="text-lg font-bold {{ $this->balanceDue > 0 ? 'text-red-900' : 'text-green-900' }}">
                    R {{ number_format($this->balanceDue, 2) }}
                </span>
            </div>
